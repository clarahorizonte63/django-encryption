! function() {
        ...
        if (e == e) {
            switch (e["data-layout"]) {
                ...
                case "twocolumn":
                    ...
                    break;
                default:
                    "vertical" == sessionStorage.getItem("data-layout") && sessionStorage.getItem("data-layout") ? (x("data-layout", "vertical"), sessionStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), k("vertical"), f()) : "horizontal" == sessionStorage.getItem("data-layout") ? (x("data-layout", "horizontal"), sessionStorage.setItem("data-layout", "horizontal"), document.documentElement.setAttribute("data-layout", "horizontal"), k("horizontal")) : "twocolumn" == sessionStorage.getItem("data-layout") && (x("data-layout", "twocolumn"), sessionStorage.setItem("data-layout", "twocolumn"), document.documentElement.setAttribute("data-layout", "twocolumn"), k("twocolumn"))
            }
            switch (e["data-topbar"]) {
                ...
                case "dark":
                    ...
                    break;
                default:
                    "dark" == sessionStorage.getItem("data-topbar") ? (x("data-topbar", "dark"), sessionStorage.setItem("data-topbar", "dark"), document.documentElement.setAttribute("data-topbar", "dark")) : (x("data-topbar", "light"), sessionStorage.setItem("data-topbar", "light"), document.documentElement.setAttribute("data-topbar", "light"))
            }
            ...
            switch (e["data-layout-mode"]) {
                ...
                case "dark":
                    ...
                    break;
                default:
                    sessionStorage.getItem("data-layout-mode") && "dark" == sessionStorage.getItem("data-layout-mode") ? (sessionStorage.setItem("data-layout-mode", "dark"), document.documentElement.setAttribute("data-layout-mode", "dark"), x("data-layout-mode", "dark")) : (sessionStorage.setItem("data-layout-mode", "light"), document.documentElement.setAttribute("data-layout-mode", "light"), x("data-layout-mode", "light"))
            }
    ...
    function N() {
        ...
        }), document.querySelector("#notificationItemsTabContent .empty-notification-elem") || (document.getElementById("notificationItemsTabContent").innerHTML += '<div class="empty-notification-elem text-center px-4">\t\t\t\t\t\t<div class="mt-3 avatar-md mx-auto">\t\t\t\t\t\t\t<div class="avatar-title bg-soft-info text-info fs-24 rounded-circle">\t\t\t\t\t\t\t<i class="mdi mdi-bell "></i>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>\t\t\t\t\t\t<div class="pb-3 mt-2">\t\t\t\t\t\t\t<h6 class="fs-16 fw-semibold lh-base">Hey! You have no any notifications </h6>\t\t\t\t\t\t</div>\t\t\t\t\t</div>'))
    }
        function M() {
        var t = 0;
    ...
    sessionStorage.getItem("defaultAttribute") ? ((a = {})["data-layout"] = sessionStorage.getItem("data-layout"), a["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size"), a["data-layout-mode"] = sessionStorage.getItem("data-layout-mode"), a["data-layout-width"] = sessionStorage.getItem("data-layout-width"), a["data-sidebar"] = sessionStorage.getItem("data-sidebar"), a["data-sidebar-image"] = sessionStorage.getItem("data-sidebar-image"), a["data-layout-position"] = sessionStorage.getItem("data-layout-position"), a["data-layout-style"] = sessionStorage.getItem("data-layout-style"), a["data-topbar"] = sessionStorage.getItem("data-topbar"), a["data-preloader"] = sessionStorage.getItem("data-preloader"), a["data-body-image"] = sessionStorage.getItem("data-body-image"), z(a)) : (i = document.documentElement.attributes, a = {}, Array.from(i).forEach(function(e) {
    ...
    })), (i = document.querySelector('[data-bs-toggle="fullscreen"]')) && i.addEventListener("click", function(e) {
        ...
        t.addEventListener("click", function(e) {
            l.hasAttribute("data-layout-mode") && "light" == t.getAttribute("data-mode") ? (C("data-layout-mode", "light", "layout-mode-light", l), sessionStorage.setItem("data-layout-auto", "false")) : l.hasAttribute("data-layout-mode") && "dark" == t.getAttribute("data-mode") ? (C("data-layout-mode", "dark", "layout-mode-dark", l), sessionStorage.setItem("data-layout-auto", "false")) : l.hasAttribute("data-layout-mode") && "auto" == t.getAttribute("data-mode") && (window.matchMedia("(prefers-color-scheme: dark)").matches ? C("data-layout-mode", "dark", "layout-mode-dark", l) : C("data-layout-mode", "light", "layout-mode-light", l), sessionStorage.setItem("data-layout-auto", "true")), sessionStorage.getItem("data-layout-auto") && "true" == sessionStorage.getItem("data-layout-auto") ? document.documentElement.classList.add("mode-auto") : document.documentElement.classList.remove("mode-auto")
        })
    }), sessionStorage.getItem("data-layout-auto") && "true" == sessionStorage.getItem("data-layout-auto") ? document.documentElement.classList.add("mode-auto") : document.documentElement.classList.remove("mode-auto"), O(), D(), S(), document.getElementsByClassName("dropdown-item-cart") && (r = document.querySelectorAll(".dropdown-item-cart").length, Array.from(document.querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn")).forEach(function(e) {
        e.addEventListener("click", function(e) {
            r--, this.closest(".dropdown-item-cart").remove(), Array.from(document.getElementsByClassName("cartitem-badge")).forEach(function(e) {
                e.innerHTML = r
            }), M(), document.getElementById("empty-cart") && (document.getElementById("empty-cart").style.display = 0 == r ? "block" : "none"), document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = 0 == r ? "none" : "block")
        })
    }), Array.from(document.getElementsByClassName("cartitem-badge")).forEach(function(e) {
        e.innerHTML = r
    }), document.getElementById("empty-cart") && (document.getElementById("empty-cart").style.display = "none"), document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = "block"), M()), document.getElementsByClassName("notification-check") && (N(), Array.from(document.querySelectorAll(".notification-check input")).forEach(function(t) {
        ...
        e && e.addEventListener("hide.bs.dropdown", function(e) {
            ...
            }), N(), document.getElementById("notification-actions").style.display = ""
        })
        ...
        document.getElementById("delete-notification").addEventListener("click", function() {
            ...
            }), N(), document.getElementById("NotificationModalbtn-close").click()
        })
    ...
    }), E(), f(), T(), window.addEventListener("resize", function() {
